...
CAM_CMD g_stCameraCmd;
	...
	const uint16_t uiZoomRatioTable[_MAX_ZOOM_PARA_NUM][_MAX_RATE] = 
	{
		#if(_RESOLUTION_TYPE == _CCD_SD)
		//480  RIGHT
		{
...
uint8_t tCmd_DZoomOn[6] = {0x81,0x01,0x04,0x06,0x02,0xff};  //DZoom on
...
//CAM_Title
uint8_t tCmd_TitleSet1_480[16]={0x81, 0x01, 0x04, 0x73, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF};		
...
uint8_t tCmd_TitleSet2_480[16]={0x81, 0x01, 0x04, 0x73, 0x01, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0xFF};
...
uint8_t tCmd_TitleSet3_480[16]={0x81, 0x01, 0x04, 0x73, 0x02, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0x1B, 0xFF};
...
uint8_t tCmd_TitleClear_480[6]={0x81, 0x01, 0x04, 0x74, 0x00, 0xFF};	//Title Setting Clear
uint8_t tCmd_TitleOn_480[6]={0x81, 0x01, 0x04, 0x74, 0x02, 0xFF};		//Title Display On
uint8_t tCmd_TitleOff_480[6]={0x81, 0x01, 0x04, 0x74, 0x03, 0xFF};		//Title Display Off	
...
void CAM_SetZoomDirect(void)
{
	...
	//9
	g_stStatusCmd.uiZoomPos = uiZoomRatioTable[g_stStatusCmd.uiModeID%_MAX_ZOOM_PARA_NUM][g_stStatusCmd.uiXRate];
	
	g_stCameraCmd.pCmd[4] = (uiZoomRatioTable[g_stStatusCmd.uiModeID%_MAX_ZOOM_PARA_NUM][g_stStatusCmd.uiXRate]&0xF000)/0x1000;
	g_stCameraCmd.pCmd[5] = (uiZoomRatioTable[g_stStatusCmd.uiModeID%_MAX_ZOOM_PARA_NUM][g_stStatusCmd.uiXRate]&0x0F00)/0x100;
	g_stCameraCmd.pCmd[6] = (uiZoomRatioTable[g_stStatusCmd.uiModeID%_MAX_ZOOM_PARA_NUM][g_stStatusCmd.uiXRate]&0x00F0)/0x10;
	g_stCameraCmd.pCmd[7] = (uiZoomRatioTable[g_stStatusCmd.uiModeID%_MAX_ZOOM_PARA_NUM][g_stStatusCmd.uiXRate]&0x000F)/0x1;
	USART_SendCmd(g_stCameraCmd.pCmd, g_stCameraCmd.CmdLen);
...
void CAM_SetDZoomOn(void)
{
	g_stCameraCmd = AllCamCmd[CAM_DZoom_On];
	USART_SendCmd(g_stCameraCmd.pCmd, g_stCameraCmd.CmdLen);
}
